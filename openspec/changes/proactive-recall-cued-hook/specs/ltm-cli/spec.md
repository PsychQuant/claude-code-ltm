...
- **THEN** the command returns after roughly N seconds plus the scan and retrieval time, the index contains only whole committed batches, and the report names the unmerged source count greater than zero
